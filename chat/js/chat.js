...
var ajaxChat = {
	...
	formatDate: function(format, date) {
        ...
        .replace(/%n/g, this.addLeadingZero(date.getMonth()+1))
        .replace(/%F/g, FullMonthArray[date.getMonth()+1])
        .replace(/%M/g, ShortMonthArray[date.getMonth()+1])
        .replace(/%d/g, this.addLeadingZero(date.getDate()))
        .replace(/%j/g, date.getDate())
        .replace(/%l/g, FullDayArray[date.getDay()])
        .replace(/%D/g, ShortDayArray[date.getDay()])
        .replace(/%H/g, this.addLeadingZero(date.getHours()))
        .replace(/%G/g, date.getHours())
        .replace(/%h/g, this.addLeadingZero(((date.getHours() >= 13) ? date.getHours() -12 : date.getHours()) == 0 ? 12 : ((date.getHours() >= 13) ? date.getHours() -12 : date.getHours())))
        .replace(/%g/g, ((date.getHours() >= 13) ? date.getHours() -12 : date.getHours()) == 0 ? 12 : ((date.getHours() >= 13) ? date.getHours() -12 : date.getHours()))
